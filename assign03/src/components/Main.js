  ...
  return (
    <main>
      ...
      <div id="skills">
        <h1>What can I do?</h1>
        <p>
          As I mentioned in the section above I'm currently learning how to use react JS. I am always trying to improve my abilities and broaden my skillset. You can find a more comprehensive list down below.
        </p>
